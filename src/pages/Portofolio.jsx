...
const ToggleButton = ({ onClick, isShowingMore }) => (
  <button
    ...
    className="
      ...
      gap-2
      bg-white/5 
      hover:bg-gradient-to-r hover:from-[#0d9488]/20 hover:to-[#22d3ee]/20
      rounded-md
      border 
      border-[#0d9488]/30
  ...
  >
    ...
    <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-[#0d9488] to-[#22d3ee] transition-all duration-300 group-hover:w-full"></span>
  </button>
);
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#0d9488] to-[#22d3ee]">
          <span style={{
        ...
        <AppBar
          ...
          sx={{
            ...
            "&::before": {
              ...
              right: 0,
              bottom: 0,
              background: "linear-gradient(180deg, rgba(13, 148, 136, 0.03) 0%, rgba(34, 211, 238, 0.03) 100%)",
          ...
          <Tabs
            ...
            sx={{
              ...
              "& .MuiTab-root": {
                ...
                "&.Mui-selected": {
                  color: "#fff",
                  background: "linear-gradient(135deg, rgba(13, 148, 136, 0.2), rgba(34, 211, 238, 0.2))",
                  boxShadow: "0 4px 15px -3px rgba(13, 148, 136, 0.2)",
                  "& .lucide": {
                    color: "#22d3ee",
                  },
                },
