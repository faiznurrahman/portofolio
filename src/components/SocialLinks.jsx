...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/faiz-nur-rahman-265b1a374/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@faizznr._",
    icon: Instagram,
    url: "https://www.instagram.com/faizznr._/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Faiznurrahman",
    icon: Github,
    url: "https://github.com/faiznurrahman",
    color: "#ffffff",
